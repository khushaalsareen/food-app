              ...
              searchedRestaurant?.dishes?.map((dish: any) => (
                ...
                >
                  ...
                  <CardContent className="p-4">
                    ...
                    {dish.restaurant && (
  <div className="mt-4 text-gray-600 dark:text-gray-400 text-sm space-y-1">
    <p>
      Restaurant:{" "}
    ...
    {dish?.rating > 0 && (
      <div className="flex items-center gap-1 pt-1 text-orange-600 dark:text-orange-400 font-medium">
        <span>Rating:</span>
