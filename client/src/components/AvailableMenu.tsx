    ...
    <div className="container mx-auto px-4 py-6 lg:px-8">
      ...
      <div className="text-center mb-8 lg:mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-300 text-sm md:text-base max-w-2xl mx-auto">
          Discover our delicious collection of handcrafted dishes made with
          fresh ingredients
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-6">
        {menus.map((menu: MenuItem) => (
          <Card
            key={menu._id}
            className="group hover:shadow-xl transition-all duration-300 border-0 shadow-md hover:scale-[1.02] bg-white dark:bg-gray-800 overflow-hidden"
          >
            {/* Image Container */}
